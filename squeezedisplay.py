...
subprocess.call(['sudo', '/home/pi/bw_rpi_tools/bw_spi/bw_lcd', '-a', SPI_ADR, '-D', SPI_DEV, '-T', '0,1',  sq.get_track_title()[0:20]])
subprocess.call(['sudo', '/home/pi/bw_rpi_tools/bw_spi/bw_lcd', '-a', SPI_ADR, '-D', SPI_DEV, '-T', '0,2',  'Artist:' ])
subprocess.call(['sudo', '/home/pi/bw_rpi_tools/bw_spi/bw_lcd', '-a', SPI_ADR, '-D', SPI_DEV, '-T', '0,3',  sq.get_track_artist()[0:20]])
